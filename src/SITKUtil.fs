...
type VoxImage private (img : Image,uniqueName : string) =
    ...
    static member Near (img : VoxImage) = new VoxImage(SimpleITK.BinaryDilate(img.Image,1ul,KernelEnum.sitkBox,1.0))
    static member Interior (img : VoxImage) = new VoxImage(SimpleITK.BinaryErode(img.Image,1ul,KernelEnum.sitkBox,0.0))
